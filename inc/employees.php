<?php
  ...
  if ( ! function_exists( 'gc_update_logged_in_employee' ) ) {
  ...
  if ( ! function_exists( 'gc_get_time_elapsed' ) ) {
  ...
  if ( ! function_exists( 'gc_actually_get_time_elapsed' ) ) {
  ...
  if ( ! function_exists( 'gc_log_out_employee' ) ) {
